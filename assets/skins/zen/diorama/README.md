...
The first `AnimatedSprite2D` overlay pass was rejected in live review. Its
source sheets remain for comparison, but they are not active. They lacked
shared pivots, clean plates, and occlusion masks, so they read as stickers
rather than parts of the world. Petals remain independent particles.
